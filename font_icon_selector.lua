                ...
                for code = range.start, range.laFin do
                    ...
                    if success and char then
                        ...
                        if self.r.ImGui_Button(ctx, "##icon_" .. code, cell_size, cell_size) then
                            ...
                            if CONFIG.BUTTON_CUSTOM_PROPERTIES[self.current_button.property_key] then
                            ...
                            --tostring(CONFIG.BUTTON_CUSTOM_PROPERTIES[self.current_button.property_key].icon_char) .. "\n")
                            end
