local action_chunk = {
  ...
  group_index = 31,
  group_count = 37,
  group_id = "Other All Tracks All Tracks Unsolo Track Unsolo Unsolo Tracks",
  group_label = "Track [Other] - Cluster 3 (all tracks_all_tracks) / Cluster 2 (unsolo_track unsolo_unsolo tracks)",
  prefix_key = "Track",
  prefix_label = "Track",
