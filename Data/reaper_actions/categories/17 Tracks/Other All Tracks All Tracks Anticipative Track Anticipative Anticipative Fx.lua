local action_chunk = {
  ...
  group_index = 30,
  group_count = 37,
  group_id = "Other All Tracks All Tracks Anticipative Track Anticipative Anticipative Fx",
  group_label = "Track [Other] - Cluster 3 (all tracks_all_tracks) / Cluster 3 (anticipative_track anticipative_anticipative fx)",
  prefix_key = "Track",
  prefix_label = "Track",
